...
public class HttpClientJava extends OkHttpClient {

    private HttpClientJava() {
    }

    public static final HttpClientJava INSTANCE = new HttpClientJava();
    ...
    public <T> void get(String path, final Type type, final EntityCallbackJava<T> entityCallback) {
