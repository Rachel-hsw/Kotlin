...
import com.example.core.BaseViewHolderJava;
...
public class LessonAdapterJava extends RecyclerView.Adapter<LessonAdapterJava.LessonViewHolder> {
    private List<LessonJava> list = new ArrayList<>();

    void updateAndNotify(List<LessonJava> list) {
        this.list = list;
     ...
     * 静态内部类
     */
    public static class LessonViewHolder extends BaseViewHolderJava {
        ...
        void onBind(LessonJava lesson) {
            ...
            final LessonJava.State state = lesson.getState();
            if (state != null) {
